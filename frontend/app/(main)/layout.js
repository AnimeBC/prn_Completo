...
/** Ondas decorativas: solo en el home (como hasta ahora). */
function Waves() {
  return (
...
/**
 * Cromo PERSISTENTE de todas las rutas (main): header, sidebar y fondo.
 * Vive en el layout -> NO se reemplaza con los loading.js de cada página:
 * durante la carga el lateral izquierdo se queda fijo empujando el contenido
 * (como en PC) y no hay salto de layout. En móvil el sidebar sigue siendo
 * drawer off-canvas (mismo comportamiento de siempre).
 */
